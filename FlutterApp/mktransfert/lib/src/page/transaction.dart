              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: CircleAvatar(
                      radius: 40,
                      backgroundImage: NetworkImage('https://firebasestorage.googleapis.com/v0/b/africanstyle-15779.appspot.com/o/logomk.png?alt=media&token=85cfbbb5-ccb9-4478-9b45-2af5167cf8da'),
                    ),
                  ),
                  SizedBox(height: 5.0),
                  Text(

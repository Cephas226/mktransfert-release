                    ...
                    if (!snapshot.hasData) {
                      ...
                      return  Column(
                        children: <Widget>[
                          ...
                          ProfileHeader(
                            avatar: NetworkImage('https://firebasestorage.googleapis.com/v0/b/africanstyle-15779.appspot.com/o/logomk.png?alt=media&token=85cfbbb5-ccb9-4478-9b45-2af5167cf8da'),
                       ...
                       children: [
                          Card(
                            child: ExpansionTile(   
                                        ...
                                        initiallyExpanded : selected!=selected,
                                        leading: Icon(Icons.credit_card),
                                        title: Text('Information utilisateur',style: TextStyle( fontSize: 17.0,fontWeight: FontWeight.bold)), 
                                        children: <Widget>[                                       
                                                        ...
                                                        children: [
                                                          ...
                                                          child: TextField( 
                                                            decoration: InputDecoration(
                                                              ...
                                                              hintText: 'Entre le titre',
                                                              suffixIcon: Icon(Icons.list_sharp),
                                                            ),
                                                          ),
                                                              )],
                                                      )
                                      ...
                                      Card(
                                        ...
                                        title: Text('Informations document',style: TextStyle( fontSize: 17.0,fontWeight: FontWeight.bold)),
                                        children: <Widget>[                                       
                                          Padding(padding: EdgeInsets.all(25.0), 
                                                      child : Column(
                                                        children: [
                                      ...
                                      Card(
                                        ...
                                        title: Text('Montant et paiement',style: TextStyle( fontSize: 17.0,fontWeight: FontWeight.bold)),
                                        children: <Widget>[                                       
                                          Padding(padding: EdgeInsets.all(25.0), 
                                                      child : Column(
                                                        children: [

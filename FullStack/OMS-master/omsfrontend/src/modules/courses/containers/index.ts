...
export const CoursesContainers = [CoursesPlannerContainer,CoursesListComponent,CoursePlannerListContainerComponent,CoursesCardContainer,CoursesEditConteners,CoursesDetailsConteners];
